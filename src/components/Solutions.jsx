...
//             }}
//               >travelsgroup provides a wide range of top-rated hotels and flights at competitive prices. Our emphasis on premier accommodation and personalized services sets us apart from other travel agencies, 
//                 ensuring that our customers enjoy a hassle-free and delightful travel experience.</Typography>
//                 <Button
//                 sx={{
//                     color:'#FFFFFF', backgroundColor:'#FFA400',
//                 borderRadius:'20px 0px 0px 0px',
//                   padding: '10px 20px',
//                    '&:hover': {
//                 backgroundColor: 'rgba(219 100 28)' // Darker shade on hover
//               }
//                 }}
